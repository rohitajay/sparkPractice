...
def computeCosineSimilarity(spark, data):
    ...
    .withColumn("score", \
                func.when(func.col("denominator") != 0, func.col("numerator") /
                          func.col("denominator"))\
                .otherwise(0)\
...
movieNames = spark.read \
    ...
    .csv("/home/administrator/PycharmProjects/sparkProject/spark_advanced/Data/ml-100k/u.item")
...
movies = spark.read.option("sep","\t")\
    .schema(moviesSchema) \
    .csv("/home/administrator/PycharmProjects/sparkProject/spark_advanced/Data/ml-100k/u.data")
